...
def connect():
    ...
    subprocess.run("gnome-terminal -- bash -c 'sudo rfcomm connect escape 98:DA:60:07:C6:AC 1; exec bash'", shell=True)#이어폰
...
connect()
time.sleep(5)
subprocess.run("gnome-terminal -- bash -c 'python3 /home/escape/escape_project/listen_bt.py; exec bash'", shell=True)#bluetooth.py로 수정
time.sleep(1)
